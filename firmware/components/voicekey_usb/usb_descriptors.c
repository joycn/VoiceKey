...
#define VK_CONFIG_LEN (TUD_CONFIG_DESC_LEN + TUD_AUDIO_MIC_ONE_CH_DESC_LEN + TUD_HID_DESC_LEN)
const uint8_t vk_configuration_descriptor[] = {
    ...
    TUD_AUDIO_DESC_IAD(VK_ITF_AUDIO_CONTROL, 2, 3),
    ...
    TUD_AUDIO_DESC_CS_AC(0x0200, AUDIO_FUNC_MICROPHONE,
        ...
        TUD_AUDIO_DESC_FEATURE_UNIT_ONE_CHANNEL_LEN, 0),
...
uint16_t const *tud_descriptor_string_cb(uint8_t index, uint16_t langid) {
    ...
    static const char *const strings[] = {NULL, "VoiceKey Prototype", "VoiceKey Microphone",
        "VoiceKey Microphone", "VoiceKey"};
    size_t count;
