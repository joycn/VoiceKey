...
> **当前设备：官方示例参数白色呼吸版已烧录，用户确认“呼吸灯是正常了”。** 白色速度1、亮度255，不主动覆盖Gamma（本次读回0）；彩虹保持速度1、亮度30、Gamma0。应用f7425d63…、运行ELFda4351d1…匹配，四段烧录哈希通过，约10秒51次采样无控制、采集或传输故障。本版彩虹切换未单独重新确认。[记录](device-records/2026-09-19-official-white.md)。
